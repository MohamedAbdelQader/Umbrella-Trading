...
namespace UmbrellaTrading.MVC
{
    ...
    public class program
    {
        public static int Main()
        {
            ...
            builder.Services.AddDbContext<UmbrellaTradingContext>(i =>
            {
                i.UseLazyLoadingProxies().UseSqlServer
                (builder.Configuration.GetConnectionString("Umbrella-Trading"));
            });

            builder.Services.AddIdentity<User, IdentityRole>()
               .AddEntityFrameworkStores<UmbrellaTradingContext>();
