...
namespace UmbrellaTrading.Repositories
{
    public class VendorRepository : GeneralRepositories<Vendor>
    {
        ...
        public VendorRepository(UserRepository _userrepo, UmbrellaTradingContext _DBContext
            ...
            int pagesize = 20)
        {
            ...
            if (!string.IsNullOrEmpty(_BrandNameAr))
                filterd = filterd.Or(p => p.BrandName .Contains(_BrandNameAr));
        ...
        public async Task<Vendor> Add(UserVendorEditViewModel model) {
            ...
            user.Img = model.VendorImage.Select(p =>
