...
namespace UmbrellaTrading.Repositories
{
    public class MarketerRebository : GeneralRepositories<Marketer>
    {
        ...
        public MarketerRebository(UserManager<User> _UserMan, CollectionRepository CollRepo,UserRepository _UserRepo, UmbrellaTradingContext _DBContext,UnitOfWork _unit) : base(_DBContext)
        {
            unit = _unit;
            UserMan = _UserMan;
            UserRepo = _UserRepo;
