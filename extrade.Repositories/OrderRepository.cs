...
namespace UmbrellaTrading.Repositories
{
    public class OrderRepository :GeneralRepositories<Order>
    {
        ...
        public OrderRepository(UmbrellaTradingContext _DBContext) : base(_DBContext) { }
        ...
        public OrderViewModel EditOrderStatus(int ID)
        {
            ...
            if (query.OrderStatus == OrderStatus.pending)
            {
                query.OrderStatus = OrderStatus.accepted;
            }
            else if (query.OrderStatus == OrderStatus.rejected)
                query.OrderStatus = OrderStatus.accepted;

            else if (query.OrderStatus == OrderStatus.accepted)
